...
public class Hitbox {
  ...
  public boolean doesCollide(Hitbox other) {
    ...
    boolean xOverlap = (coordinates[0] < other.coordinates[0] + other.width) && (coordinates[0] + width > other.coordinates[0]);
    
    boolean yOverlap = (coordinates[1] < other.coordinates[1] + other.height) && (coordinates[1] + height > other.coordinates[1]);
    
    return xOverlap && yOverlap; //default return statement to compile, feel free to change
  }
